...
class AI(DataObject):
    def __init__(self, name):
        ...
        self.__charge_required_images()
        self.__charge_description()
        self.__charge_required_patient_medical_information()
        self.__charge_required_skin_lesion_characteristics()
...
#        pass
    ...
    def __charge_required_images(self):
    ...
    def __charge_required_patient_medical_information(self):
    ...
    def __charge_required_skin_lesion_characteristics(self):
