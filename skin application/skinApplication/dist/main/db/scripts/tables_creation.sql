...
INSERT INTO PATIENTS (id, first_name, last_name, birth_date, gender, medical_information) VALUES ("MA4726RD", "Martine", "Bernard", '08-03-1978', 0, '{"eye_color":"Hazel","hair_color":"Blonde"}');
...
INSERT INTO SKIN_LESIONS (number, id_patient, location, characteristics, ai_results) VALUES (0, "AG3526CA", "0,0.5,0.4", '{"diameter":100}', '{"AI-01":{"Risk": "MALIGNANT", "Type":"Melanoma", "Accurance:":87}}');
INSERT INTO SKIN_LESIONS (number, id_patient, location, characteristics, ai_results) VALUES (1, "AG3526CA", "1,0.5,0.3", '{"diameter":100}', '{"AI-01":{"Risk": "BENIGN", "Type":"Mole", "Accurance:":83}, "AI-02":{"Risk": "BENIGN", "Type":"Mole", "Accurance:":87}, "AI-03":{"Risk": "BENIGN", "Type":"Mole", "Accurance:":90}}');
INSERT INTO SKIN_LESIONS (number, id_patient, location, characteristics, ai_results) VALUES (2, "AG3526CA", "2,0.5,0.4", '{"diameter":100}', '{}');
