...
class Ui_upsert_skin_lesion(object):
    def setupUi(self, upsert_skin_lesion):
        ...
        self.bt_delete_skin_lesion = Button(upsert_skin_lesion)
        self.bt_delete_skin_lesion.setObjectName(u"bt_delete_skin_lesion")

        self.ly_left.addWidget(self.bt_delete_skin_lesion, 0, Qt.AlignHCenter)
    ...
    def retranslateUi(self, upsert_skin_lesion):
        ...
        self.bt_delete_skin_lesion.setText(QCoreApplication.translate("upsert_skin_lesion", u"Delete skin lesion", None))
