...
class SkinLesionPreview(PromotedContainer):
    ...
    s_update = Signal(SkinLesion)
    s_see_timeline = Signal(SkinLesion)
    s_see_images = Signal(SkinLesion)
    ...
    def __update(self):
        self.s_update.emit(self.skl)

    def __see_timeline(self):
        self.s_see_timeline.emit(self.skl)

    def __see_images(self):
        self.s_see_images.emit(self.skl)
