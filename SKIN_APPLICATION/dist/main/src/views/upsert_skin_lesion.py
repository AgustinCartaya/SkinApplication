...
class UpsertSkinLesionView(ViewObject):
    ...
    def load_ui(self):
        ...
        # bt delete skin lesion
        self.ui.bt_delete_skin_lesion.set_type(Button.BT_DELETE)
        self.ui.bt_delete_skin_lesion.hide()
    ...
    def connect_ui_signals(self):
        ...
        # delete skin lesion
        self.ui.bt_delete_skin_lesion.clicked.connect(self.__delete_skin_lesion)
    ...
    def __save_information(self):
        if self.skl is None:
            self.skl = SkinLesion(self.p.get_next_skl_number(), self.p.id, self.ui.c_body2d.get_point_info(), self.__catch_characteristics())
            self.skl.create()
    ...
    def charge_edit_mode(self):
        ...
        # delete button
        self.ui.bt_delete_skin_lesion.show()
    ...
    @Slot()
    def __delete_skin_lesion(self):
        reply = QMessageBox.question(self.mv,
                                    'Delete',
                                    tf.f('Are you sure you want to delete this skin lesion?'),
