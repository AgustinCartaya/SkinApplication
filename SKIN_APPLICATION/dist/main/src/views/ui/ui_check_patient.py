...
class Ui_check_patient(object):
    def setupUi(self, check_patient):
        ...
        self.horizontalLayout.setContentsMargins(9, -1, 9, 20)
        self.bt_delete_patient = Button(self.c_patient_information)
        self.bt_delete_patient.setObjectName(u"bt_delete_patient")

        self.horizontalLayout.addWidget(self.bt_delete_patient, 0, Qt.AlignHCenter)
        ...
        self.horizontalLayout.addWidget(self.bt_edit_patient_info, 0, Qt.AlignHCenter)
    ...
    def retranslateUi(self, check_patient):
        ...
        self.bt_delete_patient.setText(QCoreApplication.translate("check_patient", u"Delete patient", None))
        self.bt_edit_patient_info.setText(QCoreApplication.translate("check_patient", u"Edit patient", None))
